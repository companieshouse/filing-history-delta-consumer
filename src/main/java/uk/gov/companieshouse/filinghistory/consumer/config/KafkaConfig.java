...
import uk.gov.companieshouse.filinghistory.consumer.kakfa.InvalidMessageRouter;
import uk.gov.companieshouse.filinghistory.consumer.kakfa.MessageFlags;
...
public class KafkaConfig {
    ...
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, ChsDelta>> kafkaListenerContainerFactory(
            ConsumerFactory<String, ChsDelta> consumerFactory, @Value("${consumer.concurrency}") Integer concurrency) {
    ...
    public ProducerFactory<String, Object> producerFactory(
            @Value("${spring.kafka.bootstrap-servers}") String bootstrapServers,
            @Value("${consumer.group_id}") String groupId,
        ...
        return new DefaultKafkaProducerFactory<>(
                Map.of(
                        ...
                        ChsDeltaSerialiser.class,
                        ProducerConfig.INTERCEPTOR_CLASSES_CONFIG,
                        InvalidMessageRouter.class.getName(),
                        "message.flags", messageFlags,
                        "invalid.topic", "%s-%s-invalid".formatted(groupId, topic)),
    ...
    @Bean
    public RetryTopicConfiguration myRetryTopic(KafkaTemplate<String, ChsDelta> template,
            @Value("${consumer.backoff-delay}") int backoff,
