...
class SentenceCaseTransformerTest {
    ...
    private static Stream<Arguments> sentenceCaseFormatting() {
        return Stream.of(
                ...
                Arguments.of("NOTICE OF STATEMENT OF AFFAIRS/2.14B/2.15B", "Notice of statement of affairs/2.14B/2.15B"), //is description values
                Arguments.of("TRANSACTION OSTM03- BR000273 PERSON AUTHORISED TO REPRESENT TERMINATED 29/12/2012 NICOLAS THEMISTOCLI", "Transaction OSTM03- BR000273 person authorised to represent terminated 29/12/2012 nicolas themistocli"), //should be charge_details.
                Arguments.of("NI011703", "NI011703"),
                Arguments.of("APPLICATION BY A PUBLIC COMPANY FOR RE-REGISTRATION AS A PRIVATE COMPANY FOLLOWING A COURT ORDER REDUCING CAPITAL", "Application by a public company for re-registration as a private company following a court order reducing capital"),
                Arguments.of("Inconsistency At the time of filing, this document appeared to be inconsistent with other information filed against the company. A TM01 has been received to terminate David Lawrence as a director from 23/10/09, however, this person is no longer a director on our records.", "Inconsistency at the time of filing, this document appeared to be inconsistent with other information filed against the company. A TM01 has been received to terminate David Lawrence as a director from 23/10/09, however, this person is no longer a director on our records."), //this one is an interesting case, in the perl it capitalises the At but proper sentence case should be first word capitalised and the other ones not.
                Arguments.of("NOTIFICATION OF A PERSON WITH SIGNIFICANT CONTROL RELEVANT LEGAL ENTITY", "Notification of a person with significant control relevant legal entity"),
                Arguments.of("NOTIFICATION OF A PERSON WITH SIGNIFICANT CONTROL OTHER REGISTRABLE PERSON", "Notification of a person with significant control other registrable person"),
                Arguments.of("LLP MEMBER APPOINTED MONEY & MORTGAGES [UK] LLP", "LLP member appointed money & mortgages [uk] LLP"),
                Arguments.of("[AMENDED] CERTIFICATE OF CONSTITUTION OF CREDITORS' COMMITTEE", "[Amended] certificate of constitution of creditors' committee"),
                Arguments.of("", ""),
