...
class DeltaNodeMapperTest {
    ...
    void shouldMapDeltaObjectOntoObjectNode() {
        ...
        final JsonNode expectedTopLevelNode = getExpectedJsonNode(objectMapper.createObjectNode()
                .put("acc_type", "small")
    ...
    private static JsonNode getExpectedJsonNode(ObjectNode originalValues) {
        ObjectNode expectedTopLevelNode = objectMapper.createObjectNode()
                .put("company_number", "12345678")
                .put("_entity_id", "3063732185")
